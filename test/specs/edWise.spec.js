...
for (let school of testdata.schools) {
    ...
    describe('EdWise test', () => {
        ...
        it('Click on the dropdown and select educatoin ogrgatization', async () => {
        ...
        for (let card of testdata.cards) {
            let j = 0;
            it(`Select the ${card} Request Card`, async () => {
            ...
            it(`Fill the ${card} Request Card Details`, async () => {
        ...
        it('Click on the review and submit button', async () => {
        ...
        it('Click submit for approval button', async () => {
            await changeRequestPage.clickButton("Submit All");
            await changeRequestPage.$changeSuccess().waitForDisplayed({ timeout: 500000, timeoutMsg: "not Submitted" })
        ...
        for (let i = 1; i < 4; i++) {
            ...
            it('Click on the Secound dropdown', async () => {
                await selectUser.spinnrerWait();
            ...
            it('Click on the request queue button', async () => {
            ...
            for (let crID = 0; crID < crId.length; crID++)
                {
                    ...
                    it(`Click on the Assign to me button for CRID:${crId[crID]}`, async () => {
                    ...
                    it('Click on the approver button', async () => {
                    ...
                    it('Click on the status dropdown and set it to Approved', async () => {
                        await approverQue.selectStatus("Approved");
                    });

                    it('Click on the submit button and verify submission', async () => {
